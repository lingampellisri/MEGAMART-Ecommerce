...
const btn111 = document.querySelector('.talk');
...
function speakThis(message) {
    ...
    if (message.includes('click help') || message.includes('go to help')) {
    ...
    else if (message.includes('my orders') || message.includes('myorders') || message.includes('orders'))
    {
       ...
       speech.text = finalText;
        ...
        || message.includes('drumsticks') || message.includes('drumstick') || message.includes('onion') || message.includes('potato')) {
        ...
        || message.includes('thumbs up') || message.includes('string') || message.includes('sprite') || message.includes('mountain dew')
        || message.includes('orange pulpi') || message.includes('sting') || message.includes('thumps up') || message.includes('maaza')
        || message.includes('maza')) {
        ...
        || message.includes('paractomal 500mg') || message.includes('calcium capsule') || message.includes('antiseptic cream') || message.includes('hydraselum 20%')
        || message.includes('vapourrub')
        || message.includes('ataphile') || message.includes('obagi serup') || message.includes('vitaminB12') || message.includes('Med Derma')
        || message.includes('medcines') || message.includes('eno')) {
        ...
        || message.includes('himalaya cream') || message.includes('yardles powder') || message.includes('johnson baby oli') || message.includes('yardley perfume')
        || message.includes('vaseline') || message.includes('vaslin') || message.includes('eye lines') || message.includes('himalaya fairness cream')
        || message.includes('niva body lotion') || message.includes('ponds gel') || message.includes('lalime body cream') || message.includes('lipstick')
        || message.includes('powder') || message.includes('lakme body cream') || message.includes('ponds glej') || message.includes('i lines')
        || message.includes('Johnson Baby Oli') || message.includes('eyeliner')) {
        window.open(`https://localhost:44340/cosmetics.aspx`, "_self");
        const finalText = "opening  " + message;
        speech.text = finalText;
    }
    //else if (message.includes('open cosmetics') || message.includes(' cosmetics') || message.includes('back to  cosmetics')
    //    || message.includes('himalaya cream') || message.includes('yardles powder') || message.includes('johnson baby oli') || message.includes('yardels perfume')
    //    || message.includes('vaseline') || message.includes('eye lines')
    //    || message.includes('niva body lotion') || message.includes('ponds gel') || message.includes('lalime body cream') || message.includes('lipstick')
    //    || message.includes('powder')) {
    //    window.open(`https ://localhost:44340/cosmetics.aspx`, "_blank");
    //    const finalText = "opening  " + message;
    //    speech.text = finalText;
    //}
...
/* else if (message.includes('what is') || message.includes('who is') || message.includes('what are')) {
    ...
    else if (message.includes('date') || message.includes(' current date')) {
