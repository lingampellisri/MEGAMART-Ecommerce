<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="coc.aspx.cs" Inherits="www.Megamart.com.coc" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cash on collect items</title>
    <style>
        body{
    ...
    <form id="form1" runat="server">
       ...
       <div class="he">
         <p> MEGAMART ONLINE ORDERING AND SHOPPING</p>
            ...
            <img src="coc.jpg" class="coc" alt="coc" />
            <p class="p">Cash on collect items </p>

        <div>
            <div class="details">
                <p> </p>
                <asp:Label ID="submail"  CssClass="head" Text="ENTER YOUR DETAILS" runat="server" ForeColor="White"></asp:Label>
                <table class="table1">
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label runat="server" ForeColor="White" ID="mailto" Text="SHOP EMAIL :"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td> 
                            <asp:Label runat="server" ForeColor="White" ID="fupload" Text="UPLOAD DOWNLOADED INVOICE :"  ></asp:Label>
                        </td>
