...
namespace www.Megamart.com
{
    public partial class coc : System.Web.UI.Page
    {
        ...
        void email()
        {
            ...
            mail.Subject="You have an order , customer selected  cash on collecting items the customer responsibility to collect the items";
        ...
        protected void buttonmail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect("cocsuccess.aspx");
