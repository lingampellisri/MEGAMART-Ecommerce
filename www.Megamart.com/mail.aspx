<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mail.aspx.cs" Inherits="www.Megamart.com.mail" %>
    ...
    <form id="form1" runat="server">
       ...
       <div class="he">
        ...
        <div>
            <div class="details">
                <p> </p>
                <asp:Label ID="submail" runat="server" ForeColor="White"></asp:Label>
                <table class="table1">
                    <tr>
                        <td>
                    ...
                    <td>
                      ...
                      <td>
                            <asp:TextBox runat="server" ID="address" onfocus="del()" placeholder="CUSTOMER ADDRESS" TextMode="MultiLine" Width="262px"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td> 
                            <asp:Label runat="server" ForeColor="White" ID="fupload" Text="UPLOAD YOUR DOWNLOADED INVOICE :"  ></asp:Label>
                        </td>
